...
def grade_func1(package,module,step=0,outp=sys.stdout):
    ...
    takeoffs = ['2015-01-14T08:00:00','2015-07-15T10:15:20','2015-07-16T10:15:20',
                '2015-10-08T12:30:45','2016-02-15T20:35:16','2017-01-04T08:00:00','2017-12-30 16:30:45']
    students = {'S00313' : ( 0,1,1,1,1,1,1),
                'S00331' : (-1,0,0,0,1,1,1),
                'S00353' : (-1,2,2,3,3,3,3),
                'S00362' : (-1,1,1,2,3,3,3),
                'S00378' : (-1,0,1,2,3,3,3),
                'S01139' : (-1,-1,-1,-1,-1,-1,0),
                'S00526' : (-1,-1,-1,0,1,3,3)}
    ...
    for person in students:
        for pos in range(len(takeoffs)):
            ...
            try:
                ...
                # Brock Schmutzler (10/4/24): Added the following conditional to resolve a
                # maintenance ticket in which a student's get_certification function returned
                # the string 'PILOT_NOVICE' instead of the global variable PILOT_NOVICE and
                # received an ambiguous error message that said "get_certification marked S00313
                # as 'PILOT_NOVICE' on 2015-01-14T08:00:00, but was really 'PILOT_NOVICE'."
                # Wrike ticket link: https://www.wrike.com/open.htm?id=1478882672
                if isinstance(cert, str):
                    outp.write('%s should return the variable %s not the string %s.\n' % (function, cert, repr(cert)))
